...
if (typeof __firebase_config !== "undefined") {
  // Real environment: Use injected config
  firebaseConfig = JSON.parse(__firebase_config);
} else {
  // Sandbox/Local environment: Use dummy config
  isDemoMode = true;
  firebaseConfig = {
...
const MASTER_DECK = [
  ...
  },
  {
    ...
    description:
      "The state holds thousands of acres of unused land costing millions to maintain. Sell it?",
    left: {
      label: "Hold It",
      forecast: "📉 Costly",
      budget: -5,
      voters: 0,
      pennerPoints: 0,
      feedback: "Maintenance costs continue to eat into the general fund.",
    },
    right: {
      label: "Sell It",
      forecast: "💰 Cash Injection",
      budget: 20,
      voters: 5,
      pennerPoints: 1,
      feedback: "Smart move. One-time revenue boost without raising taxes.",
    },
    pennerStance: "right",
    pennerContext:
      "Government shouldn't be a land baron. Selling unused assets puts property back on the tax rolls.",
  ...
  },
  {
    ...
    description:
      "A new $200M IT project is 3 years behind schedule. Pause and audit?",
    left: {
      label: "Keep Funding",
      forecast: "🔥 Burning Cash",
      budget: -15,
      voters: -10,
      pennerPoints: 0,
      feedback: "Sunk cost fallacy. The project continues to bleed money.",
    },
    right: {
      label: "Audit Now",
      forecast: "🛑 Stop Loss",
      ...
      voters: 10,
      pennerPoints: 1,
      feedback: "Audit revealed massive waste. You saved $50M instantly.",
    },
    pennerStance: "right",
    pennerContext:
      "We cannot keep writing blank checks for failed IT projects.",
  ...
  // --- SMART GOVERNMENT ---
  {
    ...
    description:
      "Agencies want a fee hike for 'Admin Costs'. You propose capping admin overhead at 15%.",
    left: {
      label: "Grant Hike",
      ...
      voters: -20,
      pennerPoints: 0,
      feedback: "Bureaucracy grows. Service quality stays flat.",
    },
    right: {
      label: "Cap Overhead",
      forecast: "✂️ Efficiency",
      budget: 15,
      voters: 25,
      pennerPoints: 1,
      feedback:
        "You forced efficiency. More money actually reaches the people.",
    },
    pennerStance: "right",
    pennerContext:
      "If they want more money, they must prove it goes to services, not management.",
  ...
  },
  {
    ...
    description:
      "A $50M grant program has failed its metrics for 3 years. Renew or Kill?",
    left: {
      label: "Renew",
      forecast: "🔄 Status Quo",
      budget: -20,
      voters: -15,
      pennerPoints: 0,
      feedback: "Good money after bad. Trust in government erodes.",
    },
    right: {
      label: "Auto-Clawback",
      ...
      voters: 15,
      pennerPoints: 1,
      feedback: "Funding clawed back. We invest in what actually works.",
    },
    pennerStance: "right",
    pennerContext:
      "Accountability isn't optional. Failed programs don't get refunds.",
  ...
  },
  {
    ...
    description:
      "State payments for nursing homes lag inflation. Facilities are closing.",
    left: {
      label: "Ignore It",
      forecast: "📉 Closures",
      budget: 10,
      voters: -30,
      pennerPoints: 0,
      feedback: "Grandma loses her bed. Emergency rooms flood with seniors.",
    },
    right: {
      label: "Fund Rates",
      forecast: "👵 Dignity",
      ...
      voters: 20,
      pennerPoints: 1,
      feedback: "Dignity preserved. Seniors get the care they earned.",
    },
    pennerStance: "right",
    pennerContext:
      "End-of-life dignity is non-negotiable. We must pay the actual cost of care.",
  ...
  // --- PUBLIC SAFETY ---
  {
    ...
    description:
      "Criminals flee because they know police can't chase. Restore pursuit authority?",
    left: {
      label: "Keep Ban",
      forecast: "⚠️ Crime Up",
      budget: 0,
      voters: -35,
      pennerPoints: 0,
      feedback: "Crime spikes. Thieves operate with impunity.",
    },
    right: {
      label: "Restore Pursuit",
      forecast: "🚓 Order",
      budget: -5,
      voters: 25,
      pennerPoints: 1,
      feedback: "Order restored. Criminals face consequences again.",
    },
    pennerStance: "right",
    pennerContext:
      "Handcuffing police only helps criminals. I co-sponsored the fix.",
  ...
  },
  {
    ...
    description:
      "Public drug use is rampant. Fund mandatory treatment or just harm reduction?",
    left: {
      ...
      voters: -25,
      pennerPoints: 0,
      feedback: "The chaos continues. Compassion without accountability fails.",
    },
    right: {
      label: "Mandatory Rehab",
      forecast: "🏥 Treatment",
      budget: -20,
      voters: 15,
      pennerPoints: 1,
      feedback: "Expensive, but lives are saved and streets are cleaner.",
    },
    pennerStance: "right",
    pennerContext:
      "Compassion means getting people off the street, not leaving them to die.",
  ...
  },
  {
    ...
    description:
      "Gas is $5/gal. A new bill proposes a rebate using surplus funds.",
    left: {
      label: "Block Rebate",
      forecast: "🚫 No Relief",
      budget: 15,
      voters: -25,
      pennerPoints: 0,
      feedback: "State keeps the cash. Families keep suffering.",
    },
    right: {
      label: "Send Checks",
      forecast: "💵 Relief",
      ...
      voters: 30,
      pennerPoints: 1,
      feedback: "Relief arrives. Families can afford to commute again.",
    },
    pennerStance: "right",
    pennerContext:
      "We over-collected. That money belongs to the people, not the government.",
  ...
  // --- MISC / ENERGY / EDUCATION ---
  {
    ...
    left: {
      label: "Protect Choice",
      forecast: "⚡ Reliable",
      budget: 0,
      voters: 15,
      pennerPoints: 1,
      feedback: "Grid reliability preserved. Energy bills stay lower.",
    },
    right: {
      label: "Ban Gas",
      forecast: "🚫 Costs Up",
      ...
      voters: -15,
      pennerPoints: 0,
      feedback: "Construction costs spike. Winter grid strain increases.",
    },
    pennerStance: "left",
    pennerContext:
      "Energy choice is affordability. Banning gas hurts the working class.",
  ...
  },
  {
    ...
    title: "School Choice",
    description:
      "Allow state funds to follow the student to private/charter schools?",
    left: {
      label: "Block It",
      forecast: "🏫 Status Quo",
      budget: 0,
      voters: -15,
      pennerPoints: 0,
      feedback: "Status quo. Parents trapped in failing schools.",
    },
    right: {
      label: "Empower Parents",
      forecast: "🎓 Options",
      budget: -10,
      voters: 20,
      pennerPoints: 1,
      feedback: "Competition improves quality. Kids get options.",
    },
    pennerStance: "right",
    pennerContext:
      "Every child deserves a great education, regardless of zip code.",
...
const Meter = ({ icon: Icon, value, color, label, lastChange }) => {
  ...
  return (
    <div className="flex flex-col items-center w-1/2 px-4 relative">
      {lastChange !== 0 && (
        <div
          className={`absolute -top-6 text-lg font-black animate-float-up drop-shadow-md ${
      ...
      <div
        className={`flex items-center space-x-2 mb-1 text-xs font-bold tracking-widest uppercase ${
          isDanger ? "text-red-600 animate-pulse" : "text-slate-500"
        }`}
      >
        <Icon size={14} />
        <span>{label}</span>
...
const BriefingScreen = ({ onNext }) => {
  return (
    <div className="flex flex-col items-center justify-center min-h-full bg-slate-900 text-white p-8 text-center animate-in fade-in duration-500 font-sans relative">
      ...
      <h1 className="text-3xl font-black mb-4 uppercase tracking-tight text-red-500">
        SITUATION REPORT
      </h1>
      ...
      <div className="space-y-6 max-w-md text-left mb-8">
        <div className="bg-slate-800 p-4 rounded-lg border-l-4 border-red-500">
          <h3 className="font-bold text-red-400 text-sm uppercase mb-1">
            Budget Crisis
          </h3>
          <p className="text-slate-300 text-sm leading-relaxed">
            The revenue forecast is woefully lacking due to successively poor
            fiscal decisions. We are starting in a deep deficit.
          </p>
        </div>
        <div className="bg-slate-800 p-4 rounded-lg border-l-4 border-orange-500">
          <h3 className="font-bold text-orange-400 text-sm uppercase mb-1">
            Public Pressure
          </h3>
          <p className="text-slate-300 text-sm leading-relaxed">
            The public and non-profits demand more from the budget, but the
            average citizen is taxed more than ever.
          </p>
        </div>
      </div>

      <h2 className="text-xl font-bold text-white mb-8 leading-tight">
        How will you navigate the{" "}
        <span className="text-blue-400">60-day session?</span>
      </h2>
...
const SpecialSessionScreen = ({ onContinue }) => {
  return (
    <div className="flex flex-col items-center justify-center min-h-full bg-red-900 text-white p-8 text-center animate-in zoom-in duration-500 font-sans relative">
      ...
      <h2 className="text-xl font-bold text-red-200 mb-8 uppercase tracking-widest">
        Budget Emergency
      </h2>

      <p className="text-white text-lg font-medium mb-8 max-w-xs mx-auto leading-relaxed">
        The legislature failed to balance the budget on time. You have 5 extra
        days to fix the deficit.
        <br />
        <br />
...
const SessionEndChoiceScreen = ({ onExtend, onFinish, stats }) => (
  <div className="flex flex-col items-center justify-center min-h-full bg-slate-900 text-white p-6 text-center animate-in zoom-in duration-300">
    ...
    <p className="text-slate-400 mb-8 uppercase tracking-widest text-xs">
      Day 60 / 60
    </p>
    ...
    <div className="w-full max-w-sm bg-slate-800 p-6 rounded-xl border border-slate-700 mb-8">
      ...
      <div className="space-y-3">
        <div className="flex justify-between items-center">
          ...
          <span
            className={`text-lg font-mono font-bold ${
              stats.budget <= 0 ? "text-red-500" : "text-green-500"
            }`}
          >
            {stats.budget > 0 ? "+" : ""}
            {stats.budget}%
        ...
        <div className="flex justify-between items-center">
          ...
          <span
            className={`text-lg font-mono font-bold ${
              stats.voters <= 0 ? "text-red-500" : "text-blue-500"
            }`}
          >
            {stats.voters > 0 ? "+" : ""}
            {stats.voters}%
    ...
    <div className="space-y-4 w-full max-w-xs">
      <button
        onClick={onExtend}
        className="w-full bg-orange-600 hover:bg-orange-500 text-white font-black py-4 rounded-xl shadow-lg border-b-4 border-orange-800 flex items-center justify-center gap-2"
      >
        <Gavel size={20} /> Force Special Session
        <span className="text-[10px] font-normal opacity-80 block ml-1">
          (Review & Change Votes)
        </span>
      </button>
      <button
        onClick={() => onFinish(stats)}
        className="w-full bg-slate-700 hover:bg-slate-600 text-white font-bold py-4 rounded-xl border-b-4 border-slate-900 flex items-center justify-center gap-2"
      >
        Adjourn Sine Die
        <span className="text-[10px] font-normal opacity-80 block ml-1">
          (See Final Score)
...
const GameOverScreen = ({
  ...
  const getArchetype = () => {
    if (alignment >= 85) return ARCHETYPES.CHAMPION;
    ...
    return (
      <div className="flex flex-col items-center justify-start pt-12 min-h-full bg-slate-50 text-slate-900 p-6 text-center animate-in zoom-in duration-300 overflow-y-auto font-sans relative pb-12">
        <div className="mb-4 transform transition hover:scale-110 duration-300 bg-white p-4 rounded-full border border-slate-200 shadow-lg">
          <archetype.icon
            size={64}
            className={`${archetype.color} drop-shadow-lg`}
          />
        </div>
        ...
        <h1
          className={`text-3xl font-black mb-4 ${archetype.color} uppercase leading-none tracking-tight`}
        >
          {archetype.title}
        </h1>
          ...
          <div className="flex justify-center items-center mb-2">
            <div className="text-center">
              <div className="text-[10px] text-slate-400 font-bold uppercase tracking-widest">
                Alignment with Penner's Reform Agenda
              </div>
        ...
        <div className="w-full max-w-sm bg-white p-6 border-2 border-orange-500 rounded-2xl shadow-xl relative overflow-hidden mb-12">
          ...
          <p className="text-xs text-slate-500 mb-6 font-medium relative z-10 leading-relaxed">
            I need to be able to contact you when these critical votes come up.
          ...
          <form onSubmit={handleSubmit} className="space-y-3 relative z-10">
            <input
              ...
              required
              className="w-full p-3 bg-slate-50 border border-slate-300 text-slate-900 text-sm focus:outline-none focus:border-orange-500 rounded-lg placeholder-slate-400"
              value={email}
            ...
            <button
              ...
              className="w-full bg-orange-600 hover:bg-orange-500 text-white font-black py-4 rounded-lg text-sm transition shadow-md uppercase tracking-widest flex justify-center items-center"
            >
              {isSubmitting ? (
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-full bg-slate-50 text-slate-900 p-6 text-center animate-in slide-in-from-right duration-500 font-sans">
        <div className="bg-white p-8 rounded-2xl shadow-xl border border-slate-200 max-w-sm w-full relative overflow-hidden">
          ...
          <div className="bg-slate-50 p-4 rounded-xl border-l-4 border-blue-600 text-left mb-8">
          ...
          {IS_FUNDRAISING_ALLOWED ? (
            <a
              href={DONATION_URL}
              target="_blank"
              className="block w-full bg-red-600 hover:bg-red-500 text-white font-black py-4 rounded-xl shadow-lg transform transition hover:scale-105 active:scale-95 uppercase tracking-widest text-sm flex items-center justify-center gap-2"
            >
              <CreditCard size={18} /> Donate $20.26
            </a>
          ) : (
            <div className="p-4 bg-slate-100 rounded-lg text-xs text-slate-500">
              Fundraising is currently frozen for the legislative session. Thank
              you for your support!
            </div>
          )}
          <button
            onClick={onReset}
            className="mt-6 w-full text-slate-400 hover:text-blue-600 text-xs uppercase tracking-widest font-bold py-4"
          >
            Return to Simulator
          </button>
        </div>
...
export default function App() {
  ...
  const commitSwipe = (direction) => {
    ...
    setVotes((prev) => [
      ...prev,
      { cardId: currentCard.id, direction: direction },
    ]);
    ...
    setFeedbackState({
      result: impacts.feedback,
      impacts: impacts,
      pennerContext: currentCard.pennerContext,
      isAligned: isAligned,
      reality: currentCard.reality,
      communityStats: currentCard.communityStats,
    });
    ...
    const newStats = {
      ...
      voters: stats.voters + impacts.voters,
    };
    setStats(newStats);
    ...
    <div className="flex flex-col h-[100dvh] bg-slate-50 font-sans max-w-md mx-auto shadow-2xl border-x border-slate-200 overflow-y-auto relative">
      ...
      <div className="bg-white pt-8 pb-2 px-4 border-b border-slate-200 z-10 flex-none sticky top-0 shadow-sm">
        <div className="flex justify-between items-start w-full mb-4 gap-4">
          <button
            onClick={handleUndo}
            disabled={history.length === 0 || (feedbackState && false)}
            className="w-8 h-8 bg-slate-100 hover:bg-slate-200 text-slate-500 rounded-full flex items-center justify-center shadow-sm border border-slate-300 active:scale-95 shrink-0 transition"
      ...
      <div className="flex-1 relative flex items-center justify-center p-4 bg-slate-50 select-none overflow-hidden min-h-[500px]">
        ...
        {feedbackState && (
          <div
            className="absolute inset-0 z-50 flex items-center justify-center p-6 animate-in fade-in zoom-in duration-200 bg-slate-900/70 backdrop-blur-md cursor-pointer"
            ...
            <div className="bg-white p-0 shadow-2xl text-center border border-slate-200 w-full max-w-xs relative rounded-2xl overflow-hidden">
              ...
              <div className="p-6 space-y-6">
                <div className="flex justify-center gap-2">
                  {feedbackState.impacts.budget !== 0 && (
                    <div
                    ...
                    >
                      BUDGET {feedbackState.impacts.budget > 0 ? "+" : ""}
                      {feedbackState.impacts.budget}
                    </div>
                  )}
                  {feedbackState.impacts.voters !== 0 && (
                    <div
                      className={`px-3 py-1 text-xs font-bold rounded-full ${
                        feedbackState.impacts.voters > 0
                    ...
                    >
                      TRUST {feedbackState.impacts.voters > 0 ? "+" : ""}
                      {feedbackState.impacts.voters}
                    </div>
                  )}
                </div>
                <p className="text-slate-700 text-md font-medium leading-relaxed">
                  {feedbackState.result}
                </p>
                <div
                  className={`p-4 text-left rounded-xl border-l-4 ${
                    feedbackState.isAligned
                ...
                >
                  ...
                  <p className="text-slate-600 text-xs italic leading-relaxed mb-3">
                    "{feedbackState.pennerContext}"
                  </p>
                  <div className="pt-3 border-t border-black/5 flex gap-2 items-start">
                    <History
                      size={12}
                      className="text-slate-400 mt-0.5 shrink-0"
                    />
                    <p className="text-[10px] font-bold text-slate-500 uppercase tracking-wide leading-tight">
                      {feedbackState.reality}
                    </p>
                  </div>
                </div>
                <div className="flex justify-center items-center gap-1 text-slate-400 text-[10px] uppercase tracking-widest font-bold pt-2">
                  <Globe size={12} />
                  <span>
                    {feedbackState.communityStats}% of players voted this way
                  </span>
                </div>
              </div>
              <div className="bg-blue-600 p-3 text-white font-bold text-sm uppercase tracking-widest flex items-center justify-center gap-2 animate-pulse">
                Touch to Continue <ChevronDown size={16} />
              </div>
            </div>
          </div>
        )}
        ...
        {currentCard && (
          ...
          >
            ...
            {advisorOpen && (
              <div className="absolute inset-0 z-40 bg-slate-900/95 backdrop-blur-sm p-6 flex flex-col items-center justify-center text-center animate-in fade-in slide-in-from-bottom-4 duration-200">
                <h3 className="text-purple-400 font-bold text-xs uppercase tracking-widest mb-2 flex items-center gap-2">
                  <Sparkles size={14} /> Intel Briefing
                </h3>
                {advisorLoading ? (
                  ...
                  <p className="text-slate-300 font-medium leading-relaxed text-sm border-l-2 border-purple-500 pl-4 text-left">
                    {advisorText}
                  </p>
                )}
                <button
                  ...
                  className="mt-8 text-[10px] font-bold text-slate-500 hover:text-slate-300 uppercase tracking-wider border border-slate-700 px-4 py-2 rounded"
                >
                  Close Intel
                </button>
              </div>
            ...
            <div className="flex-1 p-8 flex flex-col justify-between bg-white">
              <div>
                <h2 className="text-2xl font-black text-slate-900 mb-3 leading-tight uppercase tracking-tight">
                  {currentCard.title}
                </h2>
      ...
      <div className="fixed bottom-0 left-0 right-0 h-2 bg-slate-200 z-50">
        <div
          className="h-full bg-gradient-to-r from-orange-500 to-blue-600 transition-all duration-500"
          style={{ width: `${(cardIndex / activeDeck.length) * 100}%` }}
        ></div>
      </div>
    </div>
  );
